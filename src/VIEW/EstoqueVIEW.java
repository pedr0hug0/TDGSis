...
public class EstoqueVIEW extends javax.swing.JFrame {
    ...
    private void btn_EntradaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EntradaActionPerformed
        ...
        estoque.setT1(Integer.parseInt(txt_t1.getText()));
        estoque.setT2(Integer.parseInt(txt_t2.getText()));
        estoque.setT3(Integer.parseInt(txt_t3.getText()));
        estoque.setT4(Integer.parseInt(txt_t4.getText()));
